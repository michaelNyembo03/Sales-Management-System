...
<?php include_once "analyticstracking.php"?>
	...
	<div id="header">
		...
		<div class="page-full-width cf">
			...
			<a href="http://posnic.com/" id="company-branding" class="fr"  target="blank"><img src="<?php if (isset($_SESSION['logo'])) {echo "upload/" . $_SESSION['logo'];} else {echo "upload/michaell.png";}?>" alt="Point of Sale" /></a>
