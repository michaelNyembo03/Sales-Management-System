...
Page per Record<input name="limit" type="text"  style="margin-left:5px;" value="<?php if (isset($_GET['limit'])) {
    echo $_GET['limit'];
} else {
    echo "10";
}
...
<?php }?>
		...
		<div id="footer">
		<p>Any Queries email to <a href="mailto:sridharkalaibala@gmail.com?subject=Stock%20Management%20System">michaelNyembo03@gmail.com</a>.</p>
